#!/usr/bin/env bash
# Builds a universal release binary, wraps it into LP-100A-App.app with the
# Info.plist template, embeds AppIcon.icns, and ad-hoc signs. Output: dist/LP-100A-App.app
#
...
cp "$BIN" "$APP/Contents/MacOS/LP-100A-App"
chmod +x "$APP/Contents/MacOS/LP-100A-App"
...
file "$APP/Contents/MacOS/LP-100A-App" | sed 's/^/    /'

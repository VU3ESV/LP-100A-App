#!/usr/bin/env bash
# Build LP-100A-App.app with the LP100A ExtensionKit extension EMBEDDED and Developer-ID
...
# host. Used by the release workflow; also runnable locally.
#
...
#
#   VERSION=0.2.10 ./scripts/package-signed.sh
#
# Env — signing (from CI secrets):
#   MACOS_CERT_P12_BASE64   base64 of the LP-100A Developer ID Application .p12 (cert + key)
...
APPEX_NAME="LP100AExtension.appex"
...
DMG="dist/LP-100A-App-${VERSION}.dmg"
